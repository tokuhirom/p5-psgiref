...
sub handler {
    ...
    PSGI::Util::foreach($body, sub { $response_content .= $_[0] });
...
PSGIRef::Impl::Mojo - Mojo daemon based PSGI handler
...
=head1 SYNOPSIS
  ...
  PSGIRef::Impl::Mojo->start($daemon, sub {
      my $env = shift;
      return [
          200,
